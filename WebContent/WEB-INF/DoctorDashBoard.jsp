...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="azure" data-background-color="white" data-image="../assets/img/sidebar-1.jpg">
      ...
      <div class="logo">                  
      	<a href="javascript:;" >
             <img class="img" src="../assets/img/logo.jpg" height="70px" width="250px"/>
         </a>
</div>
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item active ">
            <a class="nav-link" href="./Doctordash.html">
              <i class="material-icons">person</i>
              <p>Profil Du Docteur</p>
            </a>
          </li>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Profil Docteur</a>
          </div>
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="#">Tu as un nouveau visiteur</a>
                  <a class="dropdown-item" href="#">Tu as un nouveau visiteur</a>
            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Complètez votre profil</p>
                </div>
                <div class="card-body">
                  <form>
                    <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Contact Docteur</label>
                          <input type="text" class="form-control">
                        </div>
                      </div>
                                            <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Contact Cabinet</label>
                          <input type="text" class="form-control">
                        </div>
                      </div></div>
                                          <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="bmd-label-floating">Spécialité :</label><select id="Spécialité">
                            
                             <option value="">--choisis une spécialité</option>
                           <option>chirurgie esthétique</option>
                            ...
                            <option>urgentiste</option></select>
            ...
            <div class="col-md-4">
              <div class="card card-profile">
                <div class="card-avatar">
                  <a href="javascript:;">
                    <img class="img" src="../assets/img/faces/doctor2.jpg" />
                  </a>
                </div>
                <div class="card-body">
